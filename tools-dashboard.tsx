...
export default function ToolsDashboard() {
  ...
  // Filter tools based on search, country, and general tools inclusion
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="flex flex-col md:flex-row gap-4 mb-6">
        ...
        <div className="relative">
          ...
          {countryDropdownOpen && (
            <div className="absolute z-10 mt-1 w-[220px] rounded-md border bg-popover shadow-md">
              <div className="p-2">
                <div className="mb-2 px-2 py-1.5 text-sm font-semibold">Countries</div>
                ...
                {selectedCountries.length > 0 && (
                  <Button variant="ghost" size="sm" className="w-full mt-2" onClick={() => setSelectedCountries([])}>
                    Clear selection
                  </Button>
                )}
              </div>
